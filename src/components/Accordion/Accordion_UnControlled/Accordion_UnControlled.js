import Panel_UnControlled from '../Accordion_UnControlled/Panel_UnControlled'
    ...
    return (
        <div>
            ...
            <div className='mt-3 flex flex-col gap-2 '>
                {faqData.map((data) => (
                    <Panel_UnControlled key={data.question} question={data.question} answer={data.answer} />
                ))}
            </div>
...
export default Accordion_UnControlled;
