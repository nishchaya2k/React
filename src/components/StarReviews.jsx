        ...
        <div>
            <div className='flex items-center mb-2'>
                ...
                <div onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} className='relative'>
                    {
                        isHovering && (
                            <div className='absolute w-max p-2 border border-gray-300 flex mt-5 rounded-md'>
                                {ratingStar}
                                <p className='ml-2 font-semibold'>4.3 out of 5</p>
                            </div>
                        )
                    }
                    <IoIosArrowDown className={`ml-1 cursor-pointer text-gray-400 ${isHovering && 'text-gray-950'}`} />
                </div>
                <p className='m-0 pl-5 text-[#007185] text-sm'>{reviews} ratings</p>
            </div>
        </div>
    )
}
